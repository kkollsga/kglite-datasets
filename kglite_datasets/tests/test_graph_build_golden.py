...
0.15.8, 0.16.5, and 0.16.6 (last checked 2026-08-22) — the digest is
...
the engine's ordering policy — the digest is identical on 0.15.8, 0.16.5, and
0.16.6 (whose per-section ``.kgl`` CRCs change bytes, not topology).
