...
0.15.8, 0.16.5, 0.16.6, 0.16.7, 0.16.9, 0.16.12, 0.16.13, and 0.16.15 (last
checked 2026-08-30) — the digest is
...
0.16.6, 0.16.7, 0.16.9, 0.16.12, 0.16.13, and 0.16.15 (0.16.6's per-section
``.kgl`` CRCs change bytes, not topology).
