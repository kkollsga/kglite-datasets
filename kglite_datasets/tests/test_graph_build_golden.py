...
and 0.16.17 (last checked 2026-08-31) — the digest is
...
0.16.6, 0.16.7, 0.16.9, 0.16.12, 0.16.13, 0.16.15, 0.16.16, and 0.16.17
(0.16.6's per-section ``.kgl`` CRCs change bytes, not topology).
